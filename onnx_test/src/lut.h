...
public:
    ...
    static cv::Mat trilinear_forward(const float* lut, const cv::Mat &image, const int dim=16);
    static void convert_lut(const float* lut_prt, cv::Mat &lut_mat, int cell_size, int lut_dim);
private:
	/**
